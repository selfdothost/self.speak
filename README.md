# self.speak — FastAPI TTS service

> **self.speak** — the self.ai text-to-speech (TTS) service. It is a fork of
> Remsky's [Kokoro-FastAPI](https://github.com/remsky/Kokoro-FastAPI)
> (Apache-2.0) with self.ai-specific branding and deployment layered on top.
> Not affiliated with or endorsed by Remsky or hexgrad — see
> [`NOTICE`](NOTICE) for the full trademark disclaimer and provenance, and
> [`LICENSE`](LICENSE) (GPLv3); the original Apache-2.0 text is retained in
> [`LICENSE.kokoro-fastapi-apache`](LICENSE.kokoro-fastapi-apache).
